DROP TABLE IF EXISTS role, reimbursementStatus, reimbursementType, users, reimbursement;
...
INSERT INTO reimbursementType(type) values
('none'),
('full'),
('half'),
('quarter'),
...
INSERT INTO reimbursement(author, amount, dateSubmitted, dateResolved, description, resolver, status, type) values
